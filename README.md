...
- As of the current 2026-06-08 alignment, TQQQ is open again after a 2026-06-04 manual broker buy sync, so this repo should show `$0` deployable real-stock cash until a future TQQQ exit.
